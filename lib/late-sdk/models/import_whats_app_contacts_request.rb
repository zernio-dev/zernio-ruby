...
module Late
  class ImportWhatsAppContactsRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        :'account_id' => :'String',
        :'contacts' => :'Array<ImportWhatsAppContactsRequestContactsInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Late::ImportWhatsAppContactsRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Late::ImportWhatsAppContactsRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [account_id, contacts, default_tags, default_groups, skip_duplicates].hash
    end
