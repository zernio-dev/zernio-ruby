  ...
  class WebhookPayloadMessageDeliveryStatus < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Late::WebhookPayloadMessageDeliveryStatus` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Late::WebhookPayloadMessageDeliveryStatus`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'status_at')
        self.status_at = attributes[:'status_at']
      else
        self.status_at = nil
      end
    ...
    def list_invalid_properties
      ...
      if @status_at.nil?
        invalid_properties.push('invalid value for "status_at", status_at cannot be nil.')
      end
    ...
    def valid?
      ...
      event_validator = EnumAttributeValidator.new('String', ["message.delivered", "message.read", "message.failed"])
      return false unless event_validator.valid?(@event)
      return false if @message.nil?
      return false if @status_at.nil?
    ...
    def event=(event)
      validator = EnumAttributeValidator.new('String', ["message.delivered", "message.read", "message.failed"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] status_at Value to be assigned
    def status_at=(status_at)
      if status_at.nil?
        fail ArgumentError, 'status_at cannot be nil'
      end
    ...
    def hash
      [id, event, message, status_at, error, conversation, account, timestamp].hash
    end
