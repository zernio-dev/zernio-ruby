...
module Late
  class WebhooksApi
    ...
    def get_webhook_logs_with_http_info(opts = {})
      ...
      allowable_values = ["post.scheduled", "post.published", "post.failed", "post.partial", "post.cancelled", "post.recycled", "account.connected", "account.disconnected", "message.received", "message.sent", "message.edited", "message.deleted", "message.delivered", "message.read", "message.failed", "comment.received", "webhook.test"]
