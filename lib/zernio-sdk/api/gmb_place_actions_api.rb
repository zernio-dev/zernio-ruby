...
module Zernio
  class GMBPlaceActionsApi
    ...
    # @param account_id [String] 
    # @param update_google_business_place_action_request [UpdateGoogleBusinessPlaceActionRequest] 
    # @param [Hash] opts the optional parameters
    ...
    def update_google_business_place_action(account_id, update_google_business_place_action_request, opts = {})
      data, _status_code, _headers = update_google_business_place_action_with_http_info(account_id, update_google_business_place_action_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :location_id Override which location to target. If omitted, uses the account&#39;s selected location.
    # @return [Array<(UpdateGoogleBusinessPlaceAction200Response, Integer, Hash)>] UpdateGoogleBusinessPlaceAction200Response data, response status code and response headers
    def update_google_business_place_action_with_http_info(account_id, update_google_business_place_action_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: GMBPlaceActionsApi.update_google_business_place_action ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_google_business_place_action_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UpdateGoogleBusinessPlaceAction200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"GMBPlaceActionsApi.update_google_business_place_action",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: GMBPlaceActionsApi#update_google_business_place_action\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
