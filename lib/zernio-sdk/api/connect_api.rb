...
module Zernio
  class ConnectApi
    ...
    # @param account_id [String] A source connected Google Business Profile account whose OAuth grant is reused.
    ...
    # @param configure_tik_tok_ads_brand_identity_request [ConfigureTikTokAdsBrandIdentityRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConfigureTikTokAdsBrandIdentity200Response, Integer, Hash)>] ConfigureTikTokAdsBrandIdentity200Response data, response status code and response headers
    ...
    # @param connect_shopify_with_token_request [ConnectShopifyWithTokenRequest] 
    # @param [Hash] opts the optional parameters
    ...
    # @param connect_shopify_with_token_request [ConnectShopifyWithTokenRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConnectShopifyWithToken200Response, Integer, Hash)>] ConnectShopifyWithToken200Response data, response status code and response headers
    ...
    # @param connect_word_press_with_application_password_request [ConnectWordPressWithApplicationPasswordRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ConnectWordPressWithApplicationPassword200Response, Integer, Hash)>] ConnectWordPressWithApplicationPassword200Response data, response status code and response headers
    ...
    # @param create_pinterest_board_request [CreatePinterestBoardRequest] 
    # @param [Hash] opts the optional parameters
    # @return [CreatePinterestBoard201Response]
    def create_pinterest_board(account_id, create_pinterest_board_request, opts = {})
      data, _status_code, _headers = create_pinterest_board_with_http_info(account_id, create_pinterest_board_request, opts)
      data
    end
    ...
    # @param create_pinterest_board_request [CreatePinterestBoardRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(CreatePinterestBoard201Response, Integer, Hash)>] CreatePinterestBoard201Response data, response status code and response headers
    def create_pinterest_board_with_http_info(account_id, create_pinterest_board_request, opts = {})
      if @api_client.config.debugging
    ...
    # @param profile_id [String] Your Zernio profile ID (get from /v1/profiles).
    # @param [Hash] opts the optional parameters
    # @option opts [String] :redirect_url Custom redirect after connection. Must be an absolute http(s) URL or custom app scheme such as &#x60;myapp://callback&#x60;; relative and unsafe URLs return 400.
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :redirect_url Custom redirect after connection. Must be an absolute http(s) URL or custom app scheme such as &#x60;myapp://callback&#x60;; relative and unsafe URLs return 400.
    # @return [Array<(GetWordPressAuthUrl200Response, Integer, Hash)>] GetWordPressAuthUrl200Response data, response status code and response headers
