...
module Zernio
  class ConnectApi
    ...
    # @option opts [String] :redirect_url Custom redirect URL after OAuth completes (same-token platforms only). Accepts an http(s) URL, a custom app scheme for mobile deeplinks (e.g. myapp://callback), or a relative path.
