...
module Zernio
  class MessagesApi
    ...
    # @param conversation_id [String] The conversation ID
    # @param message_id [String] The platform message ID to edit (iMessage also accepts the Zernio message id)
    ...
    # @option opts [String] :sort_order Order of returned messages. Default &#x60;asc&#x60; (oldest first, chat style). X, Instagram, Telegram, WhatsApp and Reddit honor this order across cursor pages. For Facebook and Bluesky, only intra-page ordering is affected. Pages always walk newest→oldest. See &#x60;sortOrderApplied&#x60; in the response.  (default to 'asc')
    ...
    # @param account_id [String] Account ID. Required: without it the request returns 400 missing_required_field.
    # @param [Hash] opts the optional parameters
    ...
    def list_inbox_conversations_with_http_info(opts = {})
      ...
      allowable_values = ["facebook", "instagram", "twitter", "bluesky", "reddit", "telegram", "whatsapp", "imessage"]
    ...
    # @param send_typing_indicator_request [SendTypingIndicatorRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(MarkConversationRead200Response, Integer, Hash)>] MarkConversationRead200Response data, response status code and response headers
    ...
    # @param query [String] Text to search for, in message content and in the contact&#39;s name, username, or phone number
    # @param [Hash] opts the optional parameters
    ...
    def search_inbox_conversations_with_http_info(query, opts = {})
      ...
      allowable_values = ["facebook", "instagram", "telegram", "whatsapp", "sms", "slack", "imessage"]
      if @api_client.config.client_side_validation && opts[:'platform'] && !allowable_values.include?(opts[:'platform'])
        fail ArgumentError, "invalid value for \"platform\", must be one of #{allowable_values}"
      end
    ...
    # @param conversation_id [String] The conversation ID
    # @param set_conversation_thread_control_request [SetConversationThreadControlRequest] 
    # @param [Hash] opts the optional parameters
    # @return [SetConversationThreadControl200Response]
    def set_conversation_thread_control(conversation_id, set_conversation_thread_control_request, opts = {})
      data, _status_code, _headers = set_conversation_thread_control_with_http_info(conversation_id, set_conversation_thread_control_request, opts)
      data
    end
    ...
    # @param set_conversation_thread_control_request [SetConversationThreadControlRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(SetConversationThreadControl200Response, Integer, Hash)>] SetConversationThreadControl200Response data, response status code and response headers
    def set_conversation_thread_control_with_http_info(conversation_id, set_conversation_thread_control_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: MessagesApi.set_conversation_thread_control ...'
      end
      # verify the required parameter 'conversation_id' is set
      if @api_client.config.client_side_validation && conversation_id.nil?
        fail ArgumentError, "Missing the required parameter 'conversation_id' when calling MessagesApi.set_conversation_thread_control"
      end
      # verify the required parameter 'set_conversation_thread_control_request' is set
      if @api_client.config.client_side_validation && set_conversation_thread_control_request.nil?
        fail ArgumentError, "Missing the required parameter 'set_conversation_thread_control_request' when calling MessagesApi.set_conversation_thread_control"
      end
      # resource path
      local_var_path = '/v1/inbox/conversations/{conversationId}/thread-control'.sub('{' + 'conversationId' + '}', CGI.escape(conversation_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(set_conversation_thread_control_request)

      # return_type
      return_type = opts[:debug_return_type] || 'SetConversationThreadControl200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"MessagesApi.set_conversation_thread_control",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: MessagesApi#set_conversation_thread_control\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
