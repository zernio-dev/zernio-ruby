...
module Zernio
  class WhatsAppApi
    ...
    def get_whats_app_commerce_settings(account_id, opts = {})
      data, _status_code, _headers = get_whats_app_commerce_settings_with_http_info(account_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
    # @return [Array<(GetWhatsAppCommerceSettings200Response, Integer, Hash)>] GetWhatsAppCommerceSettings200Response data, response status code and response headers
    def get_whats_app_commerce_settings_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WhatsAppApi.get_whats_app_commerce_settings ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling WhatsAppApi.get_whats_app_commerce_settings"
      end
      # resource path
      local_var_path = '/v1/whatsapp/commerce-settings'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'GetWhatsAppCommerceSettings200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"WhatsAppApi.get_whats_app_commerce_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WhatsAppApi#get_whats_app_commerce_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param link_whats_app_catalog_request [LinkWhatsAppCatalogRequest] 
    # @param [Hash] opts the optional parameters
    # @return [ListWhatsAppCatalogs200Response]
    def link_whats_app_catalog(link_whats_app_catalog_request, opts = {})
      data, _status_code, _headers = link_whats_app_catalog_with_http_info(link_whats_app_catalog_request, opts)
      data
    end
    ...
    # @param link_whats_app_catalog_request [LinkWhatsAppCatalogRequest] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(ListWhatsAppCatalogs200Response, Integer, Hash)>] ListWhatsAppCatalogs200Response data, response status code and response headers
    def link_whats_app_catalog_with_http_info(link_whats_app_catalog_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WhatsAppApi.link_whats_app_catalog ...'
      end
      # verify the required parameter 'link_whats_app_catalog_request' is set
      if @api_client.config.client_side_validation && link_whats_app_catalog_request.nil?
        fail ArgumentError, "Missing the required parameter 'link_whats_app_catalog_request' when calling WhatsAppApi.link_whats_app_catalog"
      end
      # resource path
      local_var_path = '/v1/whatsapp/catalogs'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(link_whats_app_catalog_request)

      # return_type
      return_type = opts[:debug_return_type] || 'ListWhatsAppCatalogs200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"WhatsAppApi.link_whats_app_catalog",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WhatsAppApi#link_whats_app_catalog\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_whats_app_account_events(account_id, opts = {})
      data, _status_code, _headers = list_whats_app_account_events_with_http_info(account_id, opts)
      data
    end
    ...
    def list_whats_app_account_events_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WhatsAppApi.list_whats_app_account_events ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling WhatsAppApi.list_whats_app_account_events"
      end
      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] > 200
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling WhatsAppApi.list_whats_app_account_events, must be smaller than or equal to 200.'
      end

      if @api_client.config.client_side_validation && !opts[:'limit'].nil? && opts[:'limit'] < 1
        fail ArgumentError, 'invalid value for "opts[:"limit"]" when calling WhatsAppApi.list_whats_app_account_events, must be greater than or equal to 1.'
      end

      # resource path
      local_var_path = '/v1/whatsapp/account-events'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'ListWhatsAppAccountEvents200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"WhatsAppApi.list_whats_app_account_events",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WhatsAppApi#list_whats_app_account_events\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
    # @return [ListWhatsAppCatalogs200Response]
    def list_whats_app_catalogs(account_id, opts = {})
      data, _status_code, _headers = list_whats_app_catalogs_with_http_info(account_id, opts)
      data
    end
    ...
    # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
    # @return [Array<(ListWhatsAppCatalogs200Response, Integer, Hash)>] ListWhatsAppCatalogs200Response data, response status code and response headers
    def list_whats_app_catalogs_with_http_info(account_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WhatsAppApi.list_whats_app_catalogs ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling WhatsAppApi.list_whats_app_catalogs"
      end
      # resource path
      local_var_path = '/v1/whatsapp/catalogs'
      ...
      new_options = opts.merge(
        :operation => :"WhatsAppApi.list_whats_app_catalogs",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WhatsAppApi#list_whats_app_catalogs\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param account_id [String] WhatsApp account ID
    # @param catalog_id [String] Meta catalog ID
    # @param [Hash] opts the optional parameters
    # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
    # @return [UnlinkWhatsAppCatalog200Response]
    def unlink_whats_app_catalog(account_id, catalog_id, opts = {})
      data, _status_code, _headers = unlink_whats_app_catalog_with_http_info(account_id, catalog_id, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
    # @return [Array<(UnlinkWhatsAppCatalog200Response, Integer, Hash)>] UnlinkWhatsAppCatalog200Response data, response status code and response headers
    def unlink_whats_app_catalog_with_http_info(account_id, catalog_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WhatsAppApi.unlink_whats_app_catalog ...'
      end
      # verify the required parameter 'account_id' is set
      if @api_client.config.client_side_validation && account_id.nil?
        fail ArgumentError, "Missing the required parameter 'account_id' when calling WhatsAppApi.unlink_whats_app_catalog"
      end
      # verify the required parameter 'catalog_id' is set
      if @api_client.config.client_side_validation && catalog_id.nil?
        fail ArgumentError, "Missing the required parameter 'catalog_id' when calling WhatsAppApi.unlink_whats_app_catalog"
      end
      # resource path
      local_var_path = '/v1/whatsapp/catalogs'
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UnlinkWhatsAppCatalog200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['bearerAuth']

      new_options = opts.merge(
        :operation => :"WhatsAppApi.unlink_whats_app_catalog",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:DELETE, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WhatsAppApi#unlink_whats_app_catalog\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param update_whats_app_commerce_settings_request [UpdateWhatsAppCommerceSettingsRequest] 
    # @param [Hash] opts the optional parameters
    # @return [GetWhatsAppCommerceSettings200Response]
    def update_whats_app_commerce_settings(update_whats_app_commerce_settings_request, opts = {})
      data, _status_code, _headers = update_whats_app_commerce_settings_with_http_info(update_whats_app_commerce_settings_request, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(GetWhatsAppCommerceSettings200Response, Integer, Hash)>] GetWhatsAppCommerceSettings200Response data, response status code and response headers
    def update_whats_app_commerce_settings_with_http_info(update_whats_app_commerce_settings_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WhatsAppApi.update_whats_app_commerce_settings ...'
      end
      # verify the required parameter 'update_whats_app_commerce_settings_request' is set
      if @api_client.config.client_side_validation && update_whats_app_commerce_settings_request.nil?
        fail ArgumentError, "Missing the required parameter 'update_whats_app_commerce_settings_request' when calling WhatsAppApi.update_whats_app_commerce_settings"
      end
      # resource path
      local_var_path = '/v1/whatsapp/commerce-settings'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(update_whats_app_commerce_settings_request)
      ...
      new_options = opts.merge(
        :operation => :"WhatsAppApi.update_whats_app_commerce_settings",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WhatsAppApi#update_whats_app_commerce_settings\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
