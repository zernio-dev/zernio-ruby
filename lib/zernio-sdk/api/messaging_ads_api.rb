  ...
  class MessagingAdsApi
    ...
    def create_call_ad_with_http_info(create_call_ad_request, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'idempotency_key'].nil? && opts[:'idempotency_key'].to_s.length > 255
        fail ArgumentError, 'invalid value for "opts[:"idempotency_key"]" when calling MessagingAdsApi.create_call_ad, the character length must be smaller than or equal to 255.'
      end
    ...
    def create_ctwa_ad_with_http_info(ctwa_ad_request_body, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'idempotency_key'].nil? && opts[:'idempotency_key'].to_s.length > 255
        fail ArgumentError, 'invalid value for "opts[:"idempotency_key"]" when calling MessagingAdsApi.create_ctwa_ad, the character length must be smaller than or equal to 255.'
      end
    ...
    def create_messaging_ad_with_http_info(create_messaging_ad_request, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'idempotency_key'].nil? && opts[:'idempotency_key'].to_s.length > 255
        fail ArgumentError, 'invalid value for "opts[:"idempotency_key"]" when calling MessagingAdsApi.create_messaging_ad, the character length must be smaller than or equal to 255.'
      end
