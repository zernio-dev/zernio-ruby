...
module Zernio
  class AccountsApi
    ...
    def get_all_accounts_health_with_http_info(opts = {})
      ...
      allowable_values = ["facebook", "instagram", "linkedin", "twitter", "tiktok", "youtube", "threads", "pinterest", "reddit", "bluesky", "googlebusiness", "telegram", "snapchat", "discord", "slack", "whatsapp"]
