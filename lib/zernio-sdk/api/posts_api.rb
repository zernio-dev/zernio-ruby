  ...
  class PostsApi
    ...
    def create_post_with_http_info(create_post_request, opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'idempotency_key'].nil? && opts[:'idempotency_key'].to_s.length > 255
        fail ArgumentError, 'invalid value for "opts[:"idempotency_key"]" when calling PostsApi.create_post, the character length must be smaller than or equal to 255.'
      end
    ...
    def list_posts_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'offset'].nil? && opts[:'offset'] < 0
        fail ArgumentError, 'invalid value for "opts[:"offset"]" when calling PostsApi.list_posts, must be greater than or equal to 0.'
      end
