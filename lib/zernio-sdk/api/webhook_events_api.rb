...
module Zernio
  class WebhookEventsApi
    ...
    # @param on_sms_registration_action_required_request [OnSmsRegistrationActionRequiredRequest] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def on_sms_registration_action_required(on_sms_registration_action_required_request, opts = {})
      on_sms_registration_action_required_with_http_info(on_sms_registration_action_required_request, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def on_sms_registration_action_required_with_http_info(on_sms_registration_action_required_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhookEventsApi.on_sms_registration_action_required ...'
      end
      # verify the required parameter 'on_sms_registration_action_required_request' is set
      if @api_client.config.client_side_validation && on_sms_registration_action_required_request.nil?
        fail ArgumentError, "Missing the required parameter 'on_sms_registration_action_required_request' when calling WebhookEventsApi.on_sms_registration_action_required"
      end
      # resource path
      local_var_path = '/sms.registration.action_required'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(on_sms_registration_action_required_request)
      ...
      new_options = opts.merge(
        :operation => :"WebhookEventsApi.on_sms_registration_action_required",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhookEventsApi#on_sms_registration_action_required\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param on_sms_registration_status_updated_request [OnSmsRegistrationStatusUpdatedRequest] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def on_sms_registration_status_updated(on_sms_registration_status_updated_request, opts = {})
      on_sms_registration_status_updated_with_http_info(on_sms_registration_status_updated_request, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def on_sms_registration_status_updated_with_http_info(on_sms_registration_status_updated_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhookEventsApi.on_sms_registration_status_updated ...'
      end
      # verify the required parameter 'on_sms_registration_status_updated_request' is set
      if @api_client.config.client_side_validation && on_sms_registration_status_updated_request.nil?
        fail ArgumentError, "Missing the required parameter 'on_sms_registration_status_updated_request' when calling WebhookEventsApi.on_sms_registration_status_updated"
      end
      # resource path
      local_var_path = '/sms.registration.status_updated'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(on_sms_registration_status_updated_request)
      ...
      new_options = opts.merge(
        :operation => :"WebhookEventsApi.on_sms_registration_status_updated",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhookEventsApi#on_sms_registration_status_updated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param webhook_payload_whats_app_template_category_updated [WebhookPayloadWhatsAppTemplateCategoryUpdated] 
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def on_whats_app_template_category_updated(webhook_payload_whats_app_template_category_updated, opts = {})
      on_whats_app_template_category_updated_with_http_info(webhook_payload_whats_app_template_category_updated, opts)
      nil
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(nil, Integer, Hash)>] nil, response status code and response headers
    def on_whats_app_template_category_updated_with_http_info(webhook_payload_whats_app_template_category_updated, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: WebhookEventsApi.on_whats_app_template_category_updated ...'
      end
      # verify the required parameter 'webhook_payload_whats_app_template_category_updated' is set
      if @api_client.config.client_side_validation && webhook_payload_whats_app_template_category_updated.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_payload_whats_app_template_category_updated' when calling WebhookEventsApi.on_whats_app_template_category_updated"
      end
      # resource path
      local_var_path = '/whatsapp.template.category_updated'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(webhook_payload_whats_app_template_category_updated)
      ...
      new_options = opts.merge(
        :operation => :"WebhookEventsApi.on_whats_app_template_category_updated",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: WebhookEventsApi#on_whats_app_template_category_updated\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
