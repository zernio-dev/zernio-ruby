...
module Zernio
  class AdCreativesApi
    ...
    # @param account_id [String] A tiktok or tiktokads account ID
    # @param ad_account_id [String] TikTok advertiser ID
    # @param [Hash] opts the optional parameters
    # @return [ListAdsTikTokIdentities200Response]
    def list_ads_tik_tok_identities(account_id, ad_account_id, opts = {})
      data, _status_code, _headers = list_ads_tik_tok_identities_with_http_info(account_id, ad_account_id, opts)
      data
    end
    ...
    # @param ad_account_id [String] TikTok advertiser ID
    # @param [Hash] opts the optional parameters
    # @return [Array<(ListAdsTikTokIdentities200Response, Integer, Hash)>] ListAdsTikTokIdentities200Response data, response status code and response headers
    def list_ads_tik_tok_identities_with_http_info(account_id, ad_account_id, opts = {})
      if @api_client.config.debugging
