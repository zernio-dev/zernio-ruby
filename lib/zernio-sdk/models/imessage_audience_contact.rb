...
module Zernio
  class ImessageAudienceContact < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'first_seen_at' => :'Time',
        :'opt_in' => :'ImessageAudienceContactOptIn'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::ImessageAudienceContact` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::ImessageAudienceContact`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [conversation_id, account_id, contact, name, subscribed, last_message, last_message_at, first_seen_at, opt_in].hash
    end
