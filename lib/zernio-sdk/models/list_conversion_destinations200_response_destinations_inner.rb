  ...
  class ListConversionDestinations200ResponseDestinationsInner < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::ListConversionDestinations200ResponseDestinationsInner` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::ListConversionDestinations200ResponseDestinationsInner`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'conversion_events')
        if (value = attributes[:'conversion_events']).is_a?(Array)
          self.conversion_events = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          conversion_events == o.conversion_events
    end
    ...
    def hash
      [id, name, type, status, ad_account_id, conversion_events].hash
    end
