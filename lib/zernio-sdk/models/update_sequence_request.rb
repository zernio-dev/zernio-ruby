...
module Zernio
  class UpdateSequenceRequest < ApiModelBase
    attr_accessor :name
    ...
    def self.openapi_types
      {
        :'name' => :'String',
        :'description' => :'String',
        :'steps' => :'Array<UpdateSequenceRequestStepsInner>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::UpdateSequenceRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::UpdateSequenceRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [name, description, steps, exit_on_reply, exit_on_unsubscribe].hash
    end
