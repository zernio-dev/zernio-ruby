...
module Zernio
  ...
  class AnalyticsDeltaEntryMetrics < ApiModelBase
    ...
    def hash
      [impressions, reach, likes, comments, shares, saves, sends, clicks, views, follows, ig_reels_avg_watch_time, ig_reels_video_view_total_time, reposts, reels_skip_rate, completion_rate, profile_views, website_clicks, impression_sources, audience_types].hash
    end
