...
module Zernio
  class ListAdGroupAssets200Response < ApiModelBase
    ...
    def self.openapi_types
      {
        :'ad_group_id' => :'String',
        :'sitelinks' => :'Array<ListAdGroupAssets200ResponseSitelinksInner>',
        :'callouts' => :'Array<ListAdGroupAssets200ResponseCalloutsInner>',
        :'structured_snippets' => :'Array<ListAdGroupAssets200ResponseStructuredSnippetsInner>',
        :'cached_at' => :'Time',
        :'stale' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::ListAdGroupAssets200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::ListAdGroupAssets200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [ad_group_id, sitelinks, callouts, structured_snippets, cached_at, stale].hash
    end
