...
module Zernio
  class GetAdNegativeKeywordList200Response < ApiModelBase
    attr_accessor :list
    ...
    def self.openapi_types
      {
        :'list' => :'GetAdNegativeKeywordList200ResponseList',
        :'customer_id' => :'String',
        :'cached_at' => :'Time',
        :'stale' => :'Boolean'
      }
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::GetAdNegativeKeywordList200Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::GetAdNegativeKeywordList200Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [list, customer_id, cached_at, stale].hash
    end
