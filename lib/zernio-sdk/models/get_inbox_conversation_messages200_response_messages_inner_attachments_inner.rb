...
module Zernio
  class GetInboxConversationMessages200ResponseMessagesInnerAttachmentsInner < ApiModelBase
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["image", "video", "audio", "file", "sticker", "share", "template", "unsupported_type"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["image", "video", "audio", "file", "sticker", "share", "template", "unsupported_type"])
    ...
    def hash
      [id, type, original_type, mime_type, url, refresh_url, filename, preview_url, payload].hash
    end
