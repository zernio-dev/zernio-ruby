...
module Zernio
  class CreateAdCreativeRequest < ApiModelBase
    ...
    def hash
      [account_id, ad_account_id, headline, body, description, call_to_action, link_url, image_url, image_hash, carousel_cards, url_tags, promotion, creative_features, multi_advertiser, ai_disclosure].hash
    end
