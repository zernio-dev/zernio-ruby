...
module Zernio
  ...
  class CtwaAdRequestBodyCreativesInner < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@platform_post_id.nil? && @platform_post_id.to_s.length < 1
        invalid_properties.push('invalid value for "platform_post_id", the character length must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@platform_post_id.nil? && @platform_post_id.to_s.length < 1
    ...
    def platform_post_id=(platform_post_id)
      ...
      if platform_post_id.to_s.length < 1
        fail ArgumentError, 'invalid value for "platform_post_id", the character length must be greater than or equal to 1.'
      end
    ...
    def hash
      [platform_post_id, existing_post_id, object_story_id, creative_features, headline, body, image_url, video, welcome_message].hash
    end
