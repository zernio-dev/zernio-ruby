  ...
  class WebhookPayloadMessageMessage < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::WebhookPayloadMessageMessage` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::WebhookPayloadMessageMessage`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      platform_validator = EnumAttributeValidator.new('String', ["instagram", "facebook", "telegram", "whatsapp", "sms", "twitter", "bluesky", "reddit", "slack", "tiktok", "imessage"])
    ...
    def platform=(platform)
      validator = EnumAttributeValidator.new('String', ["instagram", "facebook", "telegram", "whatsapp", "sms", "twitter", "bluesky", "reddit", "slack", "tiktok", "imessage"])
