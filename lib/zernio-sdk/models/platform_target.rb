...
module Zernio
  class PlatformTarget < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'error_source' => :'String',
        :'platform_error' => :'PostPlatformError'
      }
    end
    ...
    def hash
      [platform, account_id, custom_content, custom_media, scheduled_for, platform_specific_data, status, platform_post_id, platform_post_url, published_at, removed_from_platform_at, is_trial_reel, trial_graduation_strategy, error_message, error_category, error_source, platform_error].hash
    end
