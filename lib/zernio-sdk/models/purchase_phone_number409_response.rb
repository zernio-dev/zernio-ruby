...
module Zernio
  class PurchasePhoneNumber409Response < ApiModelBase
    ...
    def valid?
      ...
      code_validator = EnumAttributeValidator.new('String', ["PURCHASE_VELOCITY", "AREA_CODE_UNAVAILABLE", "PHONE_NUMBER_UNAVAILABLE", "COUNTRY_OUT_OF_STOCK", "NO_WHATSAPP_ELIGIBLE_NUMBER"])
    ...
    def code=(code)
      validator = EnumAttributeValidator.new('String', ["PURCHASE_VELOCITY", "AREA_CODE_UNAVAILABLE", "PHONE_NUMBER_UNAVAILABLE", "COUNTRY_OUT_OF_STOCK", "NO_WHATSAPP_ELIGIBLE_NUMBER"])
