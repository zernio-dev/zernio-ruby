...
module Zernio
  ...
  class WorkflowNode < ApiModelBase
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["trigger", "send_message", "wait_for_reply", "condition", "set_variable", "delay", "webhook", "ai", "handoff", "start_call", "a_b_split", "set_field", "enroll_sequence", "add_tag", "remove_tag", "end"])
