...
module Zernio
  class WebhookPayloadCallReceivedCall < ApiModelBase
    ...
    def hash
      [id, meta_call_id, account_id, phone_number_id, direction, from, to, forward_to, contact_id, conversation_id, started_at].hash
    end
