...
module Zernio
  ...
  class WebhookPayloadMessageSentMetadata < ApiModelBase
    ...
    attr_accessor :meta_interactive
    ...
    def self.openapi_types
      {
        :'meta_interactive' => :'Hash<String, Object>',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'meta_interactive')
        if (value = attributes[:'meta_interactive']).is_a?(Hash)
          self.meta_interactive = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          meta_interactive == o.meta_interactive &&
          location == o.location &&
          contacts == o.contacts &&
    ...
    def hash
      [meta_interactive, location, contacts, quoted_message_id, thread_ts, tiktok_message_type].hash
    end
