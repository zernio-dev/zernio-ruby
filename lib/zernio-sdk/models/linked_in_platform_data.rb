...
module Zernio
  ...
  class LinkedInPlatformData < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'audience' => :'LinkedInPlatformDataAudience',
        :'reshare_url' => :'String',
        :'geo_restriction' => :'GeoRestriction',
    ...
    def hash
      [document_title, organization_urn, first_comment, disable_link_preview, audience, reshare_url, geo_restriction, poll].hash
    end
