...
module Zernio
  class ListSmsRegistrations200ResponseRegistrationsInner < ApiModelBase
    ...
    def hash
      [id, registration_type, display_name, status, brand_status, campaign_status, brand_id, campaign_id, decline_reason, tf_action_required_at, phone_numbers, awaiting_otp, admin_review_note, review_request, trust_score, throughput].hash
    end
