...
module Zernio
  class ListAdSets200ResponseAdSetsInner < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'profile_id' => :'String',
        :'currency' => :'String',
        :'budget' => :'ListAdSets200ResponseAdSetsInnerBudget',
        :'schedule' => :'ListAdSets200ResponseAdSetsInnerSchedule',
        :'targeting' => :'ListAdSets200ResponseAdSetsInnerTargeting',
        :'is_external' => :'Boolean',
    ...
    def hash
      [platform_ad_set_id, platform, ad_set_name, status, platform_ad_set_status, platform_campaign_id, platform_ad_account_id, account_id, profile_id, currency, budget, schedule, targeting, is_external, platform_created_at].hash
    end
