...
module Zernio
  class RespondToSmsRegistrationReviewRequest < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@answers.nil? && @answers.length > 20
        invalid_properties.push('invalid value for "answers", number of items must be less than or equal to 20.')
      end
    ...
    def valid?
      ...
      return false if !@answers.nil? && @answers.length > 20
      true
    end
    ...
    def answers=(answers)
      ...
      if answers.length > 20
        fail ArgumentError, 'invalid value for "answers", number of items must be less than or equal to 20.'
      end
    ...
    def hash
      [note, files, request_id, answers].hash
    end
