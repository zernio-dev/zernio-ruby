...
module Zernio
  class CreateMessagingAdRequest < ApiModelBase
    ...
    def hash
      [creative_features, tracking, account_id, ad_account_id, name, campaign_name, ad_set_name, existing_post_id, object_story_id, page_id, whatsapp_phone_number, headline, body, image_url, video, welcome_message, creatives, ad_set_id, budget_amount, budget_type, currency, end_date, countries, cities, regions, zips, metros, country_groups, custom_locations, age_min, age_max, interests, audience_id, placements, advantage_audience, objective, status, campaign_status, bid_strategy, bid_amount, roas_average_floor, dsa_beneficiary, dsa_payor, regional_regulated_categories, regional_regulation_identities, destination].hash
    end
