...
module Zernio
  class GetSmsRegistration200Response < ApiModelBase
    ...
    attr_accessor :admin_review_note
    ...
    def self.openapi_types
      {
        ...
        :'review_request' => :'SmsRegistrationReviewRequest',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'admin_review_note')
        self.admin_review_note = attributes[:'admin_review_note']
      end

      if attributes.key?(:'review_request')
        self.review_request = attributes[:'review_request']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          admin_review_note == o.admin_review_note &&
    ...
    def hash
      [id, registration_type, status, brand_status, campaign_status, decline_reason, phone_numbers, awaiting_otp, admin_review_note, review_request, campaign_content].hash
    end
