...
module Zernio
  ...
  class WebhookPayloadReferral < ApiModelBase
    ...
    def self.openapi_types
      {
        :'id' => :'String',
        :'event' => :'String',
        :'referral' => :'WebhookPayloadReferralReferral',
        :'sender' => :'WebhookPayloadReferralSender',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::WebhookPayloadReferral` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::WebhookPayloadReferral`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      event_validator = EnumAttributeValidator.new('String', ["referral.received"])
    ...
    def event=(event)
      validator = EnumAttributeValidator.new('String', ["referral.received"])
    ...
    def hash
      [id, event, referral, sender, conversation, account, timestamp].hash
    end
