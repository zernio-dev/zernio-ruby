...
module Zernio
  class CreateStandaloneAdRequest < ApiModelBase
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] ai_disclosure Object to be assigned
    def ai_disclosure=(ai_disclosure)
      validator = EnumAttributeValidator.new('String', ["OPT_IN", "OPT_OUT"])
      unless validator.valid?(ai_disclosure)
        fail ArgumentError, "invalid value for \"ai_disclosure\", must be one of #{validator.allowable_values}."
      end
    ...
    def identity_type=(identity_type)
      validator = EnumAttributeValidator.new('String', ["TT_USER", "CUSTOMIZED_USER", "BC_AUTH_TT"])
