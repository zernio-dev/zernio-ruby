...
module Zernio
  class UpdateWebhookSettingsRequest < ApiModelBase
    ...
    def list_invalid_properties
      ...
      if !@account_ids.nil? && @account_ids.length > 50
        invalid_properties.push('invalid value for "account_ids", number of items must be less than or equal to 50.')
      end
    ...
    def valid?
      ...
      return false if !@account_ids.nil? && @account_ids.length > 50
      true
    end
    ...
    def account_ids=(account_ids)
      ...
      if account_ids.length > 50
        fail ArgumentError, 'invalid value for "account_ids", number of items must be less than or equal to 50.'
      end
    ...
    def hash
      [webhook_id, _id, name, url, secret, events, is_active, custom_headers, disabled_resource_groups, profile_ids, account_ids].hash
    end
