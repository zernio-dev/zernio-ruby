...
module Zernio
  class ListAdAccounts200ResponseAccountsInner < ApiModelBase
    ...
    def hash
      [id, name, currency, business_id, business_name, status, account_status, approval_status, disable_reason, timezone_name, timezone_offset_hours_utc, minimum_daily_budget, funding_source, funding_source_details, selectable, unusable_reason].hash
    end
