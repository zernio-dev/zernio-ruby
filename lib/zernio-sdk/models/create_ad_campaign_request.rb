...
module Zernio
  class CreateAdCampaignRequest < ApiModelBase
    ...
    def hash
      [account_id, ad_account_id, name, goal, is_skadnetwork_attribution, promoted_object, buying_type, validate_only, special_ad_categories, budget_amount, budget_type, status, location_targeting_type, bid_strategy, bid_amount, roas_average_floor, portfolio_bid_strategy_id].hash
    end
