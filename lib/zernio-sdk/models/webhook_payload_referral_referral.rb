...
module Zernio
  ...
  class WebhookPayloadReferralReferral < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'referer_uri' => :'String',
        :'ad_id' => :'String',
        :'ads_context_data' => :'WebhookPayloadReferralReferralAdsContextData'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::WebhookPayloadReferralReferral` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::WebhookPayloadReferralReferral`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [ref, source, type, referer_uri, ad_id, ads_context_data].hash
    end
