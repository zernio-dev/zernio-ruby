...
module Zernio
  ...
  class LinkedInAdsPlatformDataJobs < ApiModelBase
    ...
    def self.openapi_types
      {
        :'headline' => :'LinkedInAdsPlatformDataJobsHeadline',
        :'button_label' => :'LinkedInAdsPlatformDataJobsButtonLabel',
        :'logo_url' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::LinkedInAdsPlatformDataJobs` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::LinkedInAdsPlatformDataJobs`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @button_label.nil?
        invalid_properties.push('invalid value for "button_label", button_label cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @button_label.nil?
      true
    end
    ...
    def hash
      [headline, button_label, logo_url, organization_name, show_member_profile_photo].hash
    end
