...
module Zernio
  class DuplicateAdRequest < ApiModelBase
    ...
    attr_accessor :reuse_source_creative
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'reuse_source_creative')
        self.reuse_source_creative = attributes[:'reuse_source_creative']
      else
        self.reuse_source_creative = false
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          reuse_source_creative == o.reuse_source_creative
    end
    ...
    def hash
      [ad_set_id, status_option, rename_strategy, rename_prefix, rename_suffix, sync_after, reuse_source_creative].hash
    end
