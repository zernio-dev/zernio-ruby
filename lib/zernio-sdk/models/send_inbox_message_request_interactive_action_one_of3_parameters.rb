...
module Zernio
  class SendInboxMessageRequestInteractiveActionOneOf3Parameters < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'flow_cta' => :'String',
        :'flow_action' => :'String',
        :'flow_action_payload' => :'SendInboxMessageRequestInteractiveActionOneOf3ParametersFlowActionPayload',
        :'mode' => :'String'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::SendInboxMessageRequestInteractiveActionOneOf3Parameters` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::SendInboxMessageRequestInteractiveActionOneOf3Parameters`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
