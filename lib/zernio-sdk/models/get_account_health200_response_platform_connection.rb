...
module Zernio
  ...
  class GetAccountHealth200ResponsePlatformConnection < ApiModelBase
    ...
    attr_accessor :inbound_webhook_subscribed
    ...
    def self.attribute_map
      {
        ...
        :'inbound_webhook_subscribed' => :'inboundWebhookSubscribed'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'inbound_webhook_subscribed' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'inbound_webhook_subscribed')
        self.inbound_webhook_subscribed = attributes[:'inbound_webhook_subscribed']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          inbound_webhook_subscribed == o.inbound_webhook_subscribed
    end
    ...
    def hash
      [status, checked_at, phone_status, meta_error, inbound_webhook_subscribed].hash
    end
