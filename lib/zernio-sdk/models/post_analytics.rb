...
module Zernio
  class PostAnalytics < ApiModelBase
    ...
    def hash
      [impressions, reach, likes, comments, shares, saves, clicks, views, follows, ig_reels_avg_watch_time, ig_reels_video_view_total_time, reels_skip_rate, completion_rate, profile_views, website_clicks, impression_sources, audience_types, reposts, video_duration_seconds, engagement_rate, last_updated].hash
    end
