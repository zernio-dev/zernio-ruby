...
module Zernio
  class CampaignAnalyticsResponseAnalyticsSummary < ApiModelBase
    attr_accessor :spend
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::CampaignAnalyticsResponseAnalyticsSummary` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::CampaignAnalyticsResponseAnalyticsSummary`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'search_impression_share')
        self.search_impression_share = attributes[:'search_impression_share']
      end

      if attributes.key?(:'search_budget_lost_impression_share')
        self.search_budget_lost_impression_share = attributes[:'search_budget_lost_impression_share']
      end

      if attributes.key?(:'search_rank_lost_impression_share')
        self.search_rank_lost_impression_share = attributes[:'search_rank_lost_impression_share']
      end

      if attributes.key?(:'search_top_impression_share')
        self.search_top_impression_share = attributes[:'search_top_impression_share']
      end

      if attributes.key?(:'search_absolute_top_impression_share')
        self.search_absolute_top_impression_share = attributes[:'search_absolute_top_impression_share']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          search_impression_share == o.search_impression_share &&
          search_budget_lost_impression_share == o.search_budget_lost_impression_share &&
          search_rank_lost_impression_share == o.search_rank_lost_impression_share &&
          search_top_impression_share == o.search_top_impression_share &&
          search_absolute_top_impression_share == o.search_absolute_top_impression_share
    end
