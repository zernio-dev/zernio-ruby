...
module Zernio
  ...
  class WebhookPayloadMessageMetadata < ApiModelBase
    ...
    def hash
      [quick_reply_payload, postback_payload, postback_title, callback_data, interactive_type, interactive_id, button_payload, flow_response_json, flow_response_data, story_reply, is_story_mention, referral].hash
    end
