...
module Zernio
  class CreateInboxConversation429ResponseAnyOf < ApiModelBase
    ...
    def valid?
      ...
      code_validator = EnumAttributeValidator.new('String', ["rate_limited", "new_contact_limit"])
    ...
    def code=(code)
      validator = EnumAttributeValidator.new('String', ["rate_limited", "new_contact_limit"])
