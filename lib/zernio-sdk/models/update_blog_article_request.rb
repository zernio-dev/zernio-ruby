...
module Zernio
  ...
  class UpdateBlogArticleRequest < ApiModelBase
    attr_accessor :title
    ...
    def self.openapi_types
      {
        ...
        :'author' => :'String',
        :'excerpt' => :'String',
        :'image' => :'UpdateBlogArticleRequestImage',
        :'seo' => :'CreateBlogArticleRequestSeo',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Zernio::UpdateBlogArticleRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Zernio::UpdateBlogArticleRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [title, body_html, handle, tags, author, excerpt, image, seo, is_published, publish_date].hash
    end
