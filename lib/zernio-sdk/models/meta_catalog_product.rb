...
module Zernio
  class MetaCatalogProduct < ApiModelBase
    ...
    def hash
      [id, retailer_id, name, description, url, image_url, additional_image_urls, price, sale_price, currency, availability, condition, brand, category, product_type, gtin, mpn, inventory, visibility, color, size, gender, material, pattern, custom_labels, review_status, review_rejection_reasons].hash
    end
