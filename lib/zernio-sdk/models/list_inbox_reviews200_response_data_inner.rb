...
module Zernio
  class ListInboxReviews200ResponseDataInner < ApiModelBase
    ...
    def valid?
      ...
      recommendation_type_validator = EnumAttributeValidator.new('String', ["positive", "negative"])
      return false unless recommendation_type_validator.valid?(@recommendation_type)
      true
    end
    ...
    def recommendation_type=(recommendation_type)
      ...
      unless validator.valid?(recommendation_type)
        fail ArgumentError, "invalid value for \"recommendation_type\", must be one of #{validator.allowable_values}."
      end
    ...
    def hash
      [id, platform, account_id, account_username, location_id, location_name, reviewer, rating, recommendation_type, text, created, has_reply, has_photos, photo_count, photos, reply, review_url].hash
    end
