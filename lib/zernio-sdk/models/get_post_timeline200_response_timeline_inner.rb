...
module Zernio
  class GetPostTimeline200ResponseTimelineInner < ApiModelBase
    ...
    def hash
      [date, platform, platform_post_id, impressions, reach, likes, comments, shares, saves, clicks, views, follows, completion_rate, profile_views, website_clicks, impression_sources, audience_types].hash
    end
