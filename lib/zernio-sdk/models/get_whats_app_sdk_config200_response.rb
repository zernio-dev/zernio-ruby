...
module Zernio
  class GetWhatsAppSdkConfig200Response < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'graph_api_version')
        self.graph_api_version = attributes[:'graph_api_version']
      else
        self.graph_api_version = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @graph_api_version.nil?
        invalid_properties.push('invalid value for "graph_api_version", graph_api_version cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @graph_api_version.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] graph_api_version Value to be assigned
    def graph_api_version=(graph_api_version)
      if graph_api_version.nil?
        fail ArgumentError, 'graph_api_version cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          graph_api_version == o.graph_api_version
    end
    ...
    def hash
      [app_id, config_id, graph_api_version].hash
    end
