...
| **platform_campaign_status** | **String** | Raw platform-level campaign status (Meta &#x60;effective_status&#x60;: ACTIVE, PAUSED, DELETED, ARCHIVED, IN_PROCESS, WITH_ISSUES; ChatGPT (OpenAI): the campaign&#39;s own switch, active / paused / archived, independent of the delivery &#x60;status&#x60;). Distinct from per-ad &#x60;platformStatus&#x60;. | [optional] |
