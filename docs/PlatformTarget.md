...
| **published_at** | **Time** | Timestamp when the post was published to this platform. YouTube uploads a scheduled public video up to 15 minutes early as private with YouTube&#39;s own release time, so its entry is published with this set to scheduledFor, the moment the video goes public. | [optional] |
