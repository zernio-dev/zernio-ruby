...
| [**list_google_business_locations**](ConnectApi.md#list_google_business_locations) | **GET** /v1/connect/googlebusiness/locations | List Google Business Profile locations |
...
| [**update_gmb_location**](ConnectApi.md#update_gmb_location) | **PUT** /v1/accounts/{accountId}/gmb-locations | Update Google Business Profile location |
...
account_id = 'account_id_example' # String | A source connected Google Business Profile account whose OAuth grant is reused.
...
| ---- | ---- | ----------- | ----- |
| **account_id** | **String** | A source connected Google Business Profile account whose OAuth grant is reused. |  |
...
> <ConnectShopifyWithToken200Response> connect_shopify_with_token(connect_shopify_with_token_request)
...
api_instance = Zernio::ConnectApi.new
connect_shopify_with_token_request = Zernio::ConnectShopifyWithTokenRequest.new({profile_id: 'profile_id_example', shop: 'shop_example', access_token: 'access_token_example'}) # ConnectShopifyWithTokenRequest | 

begin
  # Connect a Shopify store with a custom-app Admin token
  result = api_instance.connect_shopify_with_token(connect_shopify_with_token_request)
  p result
rescue Zernio::ApiError => e
  puts "Error when calling ConnectApi->connect_shopify_with_token: #{e}"
end
```

#### Using the connect_shopify_with_token_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<ConnectShopifyWithToken200Response>, Integer, Hash)> connect_shopify_with_token_with_http_info(connect_shopify_with_token_request)

```ruby
begin
  # Connect a Shopify store with a custom-app Admin token
  data, status_code, headers = api_instance.connect_shopify_with_token_with_http_info(connect_shopify_with_token_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <ConnectShopifyWithToken200Response>
rescue Zernio::ApiError => e
  puts "Error when calling ConnectApi->connect_shopify_with_token_with_http_info: #{e}"
end
```
...
| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **connect_shopify_with_token_request** | [**ConnectShopifyWithTokenRequest**](ConnectShopifyWithTokenRequest.md) |  |  |
...
opts = {
  ...
  limit: 56 # Integer | Max locations to return (default 100, max 500). Raise it to enumerate an account with more than 100 locations; for accounts with thousands, use search/filter instead.
}
...
> <GetConnectUrl200Response> get_shopify_connect_url(profile_id, shop, opts)
...
begin
  # Get Shopify OAuth connect URL
  result = api_instance.get_shopify_connect_url(profile_id, shop, opts)
  p result
rescue Zernio::ApiError => e
  puts "Error when calling ConnectApi->get_shopify_connect_url: #{e}"
end
```

#### Using the get_shopify_connect_url_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<GetConnectUrl200Response>, Integer, Hash)> get_shopify_connect_url_with_http_info(profile_id, shop, opts)

```ruby
begin
  # Get Shopify OAuth connect URL
  data, status_code, headers = api_instance.get_shopify_connect_url_with_http_info(profile_id, shop, opts)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <GetConnectUrl200Response>
rescue Zernio::ApiError => e
  puts "Error when calling ConnectApi->get_shopify_connect_url_with_http_info: #{e}"
end
```
...
> <GetWhatsAppSdkConfig200Response> get_whats_app_sdk_config
...
begin
  # Get Embedded Signup SDK config
  result = api_instance.get_whats_app_sdk_config
  p result
rescue Zernio::ApiError => e
...
> <Array(<GetWhatsAppSdkConfig200Response>, Integer, Hash)> get_whats_app_sdk_config_with_http_info

```ruby
begin
  # Get Embedded Signup SDK config
  data, status_code, headers = api_instance.get_whats_app_sdk_config_with_http_info
  p status_code # => 2xx
  p headers # => { ... }
