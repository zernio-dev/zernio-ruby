...
opts = {
  ...
  min_comments: 56, # Integer | Minimum comment count, applied to each page after pagination
...
| **min_comments** | **Integer** | Minimum comment count, applied to each page after pagination | [optional] |
