...
| ---- | ---- | ----------- | ----- |
| **analytics** | **Boolean** | Enable periodic analytics reads (impressions, likes, etc.) for this X account. Each X API call is metered as &#x60;posts_read&#x60; and billed pass-through (~$0.005/call at the time of writing; the actual rate depends on X&#39;s pricing tier).  | [optional] |
