...
| **raw_targeting** | **Hash&lt;String, Object&gt;** | Meta only. A raw Meta-native targeting spec passed to the ad set VERBATIM (snake_case: &#x60;geo_locations&#x60;, &#x60;custom_audiences&#x60;, &#x60;excluded_custom_audiences&#x60;, &#x60;flexible_spec&#x60;, &#x60;targeting_automation&#x60;, etc.). Use it to target specific custom or lookalike audiences, or to clone a campaign&#39;s targeting exactly. Mutually exclusive with &#x60;targeting&#x60; (sending both → 422). Sent as-is; Meta validates and surfaces any errors.  | [optional] |
