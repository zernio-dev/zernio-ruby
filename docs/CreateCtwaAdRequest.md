...
| **custom_locations** | [**Array&lt;CreateCtwaAdRequestCustomLocationsInner&gt;**](CreateCtwaAdRequestCustomLocationsInner.md) | Point-radius geo (Meta &#x60;geo_locations.custom_locations&#x60;). Use for targeting a radius around a specific lat/long when no Meta city/region key fits. &#x60;distanceUnit&#x60; is required.  | [optional] |
