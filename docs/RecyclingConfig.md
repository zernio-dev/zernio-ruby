...
| **expire_count** | **Integer** | Stop recycling after this many copies have been created. Send null on update to clear this limit. | [optional] |
| **expire_date** | **Time** | Stop recycling after this date, regardless of count. Send null on update to clear this limit. | [optional] |
