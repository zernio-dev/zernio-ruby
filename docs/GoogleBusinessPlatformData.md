...
| ---- | ---- | ----------- | ----- |
| **location_id** | **String** | Target Google Business Profile location ID (e.g. \&quot;locations/123456789\&quot;). If omitted, uses the default location. Use GET /v1/accounts/{id}/gmb-locations to list locations. | [optional] |
