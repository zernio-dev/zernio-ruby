...
| ------ | ------------ | ----------- |
| [**create_whats_app_sandbox_session**](WhatsAppSandboxApi.md#create_whats_app_sandbox_session) | **POST** /v1/whatsapp/sandbox/sessions | Start a sandbox activation for a phone |
