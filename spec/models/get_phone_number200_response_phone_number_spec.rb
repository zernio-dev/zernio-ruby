...
# Unit tests for Zernio::GetPhoneNumber200ResponsePhoneNumber
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::GetPhoneNumber200ResponsePhoneNumber do
  #let(:instance) { Zernio::GetPhoneNumber200ResponsePhoneNumber.new }

  describe 'test an instance of GetPhoneNumber200ResponsePhoneNumber' do
    it 'should create an instance of GetPhoneNumber200ResponsePhoneNumber' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::GetPhoneNumber200ResponsePhoneNumber)
    end
  end
