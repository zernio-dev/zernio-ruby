...
# Unit tests for Zernio::CreateAdSetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateAdSetRequest do
  #let(:instance) { Zernio::CreateAdSetRequest.new }

  describe 'test an instance of CreateAdSetRequest' do
    it 'should create an instance of CreateAdSetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::CreateAdSetRequest)
    end
  end
