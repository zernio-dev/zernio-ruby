...
# Unit tests for Zernio::WhatsAppTemplateButton
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::WhatsAppTemplateButton do
  #let(:instance) { Zernio::WhatsAppTemplateButton.new }

  describe 'test an instance of WhatsAppTemplateButton' do
    it 'should create an instance of WhatsAppTemplateButton' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::WhatsAppTemplateButton)
    end
  end
