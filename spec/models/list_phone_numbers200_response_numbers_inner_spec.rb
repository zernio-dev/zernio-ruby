...
# Unit tests for Zernio::ListPhoneNumbers200ResponseNumbersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::ListPhoneNumbers200ResponseNumbersInner do
  #let(:instance) { Zernio::ListPhoneNumbers200ResponseNumbersInner.new }

  describe 'test an instance of ListPhoneNumbers200ResponseNumbersInner' do
    it 'should create an instance of ListPhoneNumbers200ResponseNumbersInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::ListPhoneNumbers200ResponseNumbersInner)
    end
  end
