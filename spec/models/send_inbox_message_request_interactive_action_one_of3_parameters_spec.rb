...
# Unit tests for Zernio::SendInboxMessageRequestInteractiveActionOneOf3Parameters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::SendInboxMessageRequestInteractiveActionOneOf3Parameters do
  #let(:instance) { Zernio::SendInboxMessageRequestInteractiveActionOneOf3Parameters.new }

  describe 'test an instance of SendInboxMessageRequestInteractiveActionOneOf3Parameters' do
    it 'should create an instance of SendInboxMessageRequestInteractiveActionOneOf3Parameters' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::SendInboxMessageRequestInteractiveActionOneOf3Parameters)
    end
  end
