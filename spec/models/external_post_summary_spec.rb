...
# Unit tests for Zernio::ExternalPostSummary
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::ExternalPostSummary do
  #let(:instance) { Zernio::ExternalPostSummary.new }

  describe 'test an instance of ExternalPostSummary' do
    it 'should create an instance of ExternalPostSummary' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::ExternalPostSummary)
    end
  end
