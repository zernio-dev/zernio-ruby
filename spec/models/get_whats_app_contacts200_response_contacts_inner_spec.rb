...
# Unit tests for Late::GetWhatsAppContacts200ResponseContactsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::GetWhatsAppContacts200ResponseContactsInner do
  #let(:instance) { Late::GetWhatsAppContacts200ResponseContactsInner.new }

  describe 'test an instance of GetWhatsAppContacts200ResponseContactsInner' do
    it 'should create an instance of GetWhatsAppContacts200ResponseContactsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::GetWhatsAppContacts200ResponseContactsInner)
    end
  end
