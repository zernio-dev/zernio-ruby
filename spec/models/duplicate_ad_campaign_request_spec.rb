...
# Unit tests for Zernio::DuplicateAdCampaignRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::DuplicateAdCampaignRequest do
  #let(:instance) { Zernio::DuplicateAdCampaignRequest.new }
  ...
  describe 'test an instance of DuplicateAdCampaignRequest' do
    it 'should create an instance of DuplicateAdCampaignRequest' do
      ...
      #expect(instance).to be_instance_of(Zernio::DuplicateAdCampaignRequest)
    end
  end
  ...
  describe 'test attribute "platform"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["facebook", "instagram", "tiktok", "linkedin"])
