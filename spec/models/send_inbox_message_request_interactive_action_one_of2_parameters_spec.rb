...
# Unit tests for Late::SendInboxMessageRequestInteractiveActionOneOf2Parameters
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::SendInboxMessageRequestInteractiveActionOneOf2Parameters do
  #let(:instance) { Late::SendInboxMessageRequestInteractiveActionOneOf2Parameters.new }
  ...
  describe 'test an instance of SendInboxMessageRequestInteractiveActionOneOf2Parameters' do
    it 'should create an instance of SendInboxMessageRequestInteractiveActionOneOf2Parameters' do
      ...
      #expect(instance).to be_instance_of(Late::SendInboxMessageRequestInteractiveActionOneOf2Parameters)
    end
  end
