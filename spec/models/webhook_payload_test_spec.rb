...
# Unit tests for Zernio::WebhookPayloadTest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::WebhookPayloadTest do
  #let(:instance) { Zernio::WebhookPayloadTest.new }

  describe 'test an instance of WebhookPayloadTest' do
    it 'should create an instance of WebhookPayloadTest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::WebhookPayloadTest)
    end
  end
