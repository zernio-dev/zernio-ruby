...
# Unit tests for Zernio::YouTubePlatformData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::YouTubePlatformData do
  #let(:instance) { Zernio::YouTubePlatformData.new }

  describe 'test an instance of YouTubePlatformData' do
    it 'should create an instance of YouTubePlatformData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::YouTubePlatformData)
    end
  end
