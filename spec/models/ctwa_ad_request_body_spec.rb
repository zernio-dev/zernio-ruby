...
# Unit tests for Zernio::CtwaAdRequestBody
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CtwaAdRequestBody do
  #let(:instance) { Zernio::CtwaAdRequestBody.new }

  describe 'test an instance of CtwaAdRequestBody' do
    it 'should create an instance of CtwaAdRequestBody' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::CtwaAdRequestBody)
    end
  end
