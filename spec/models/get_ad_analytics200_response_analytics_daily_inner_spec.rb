...
# Unit tests for Zernio::GetAdAnalytics200ResponseAnalyticsDailyInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::GetAdAnalytics200ResponseAnalyticsDailyInner do
  #let(:instance) { Zernio::GetAdAnalytics200ResponseAnalyticsDailyInner.new }
  ...
  describe 'test an instance of GetAdAnalytics200ResponseAnalyticsDailyInner' do
    it 'should create an instance of GetAdAnalytics200ResponseAnalyticsDailyInner' do
      ...
      #expect(instance).to be_instance_of(Zernio::GetAdAnalytics200ResponseAnalyticsDailyInner)
    end
  end
