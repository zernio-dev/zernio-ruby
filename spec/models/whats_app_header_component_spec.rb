...
# Unit tests for Zernio::WhatsAppHeaderComponent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::WhatsAppHeaderComponent do
  #let(:instance) { Zernio::WhatsAppHeaderComponent.new }
  ...
  describe 'test an instance of WhatsAppHeaderComponent' do
    it 'should create an instance of WhatsAppHeaderComponent' do
      ...
      #expect(instance).to be_instance_of(Zernio::WhatsAppHeaderComponent)
    end
  end
