...
# Unit tests for Zernio::UpdateCommentAutomationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::UpdateCommentAutomationRequest do
  #let(:instance) { Zernio::UpdateCommentAutomationRequest.new }
  ...
  describe 'test an instance of UpdateCommentAutomationRequest' do
    it 'should create an instance of UpdateCommentAutomationRequest' do
      ...
      #expect(instance).to be_instance_of(Zernio::UpdateCommentAutomationRequest)
    end
  end
