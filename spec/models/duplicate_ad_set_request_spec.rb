...
# Unit tests for Zernio::DuplicateAdSetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::DuplicateAdSetRequest do
  #let(:instance) { Zernio::DuplicateAdSetRequest.new }

  describe 'test an instance of DuplicateAdSetRequest' do
    it 'should create an instance of DuplicateAdSetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::DuplicateAdSetRequest)
    end
  end
