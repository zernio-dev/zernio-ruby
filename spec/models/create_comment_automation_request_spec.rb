...
# Unit tests for Late::CreateCommentAutomationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::CreateCommentAutomationRequest do
  #let(:instance) { Late::CreateCommentAutomationRequest.new }
  ...
  describe 'test an instance of CreateCommentAutomationRequest' do
    it 'should create an instance of CreateCommentAutomationRequest' do
      ...
      #expect(instance).to be_instance_of(Late::CreateCommentAutomationRequest)
    end
  end
