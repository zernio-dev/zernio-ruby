...
# Unit tests for Zernio::InlineObject4
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::InlineObject4 do
  #let(:instance) { Zernio::InlineObject4.new }

  describe 'test an instance of InlineObject4' do
    it 'should create an instance of InlineObject4' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::InlineObject4)
    end
  end
