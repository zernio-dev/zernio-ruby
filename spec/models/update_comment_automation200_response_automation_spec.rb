...
# Unit tests for Zernio::UpdateCommentAutomation200ResponseAutomation
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::UpdateCommentAutomation200ResponseAutomation do
  #let(:instance) { Zernio::UpdateCommentAutomation200ResponseAutomation.new }
  ...
  describe 'test an instance of UpdateCommentAutomation200ResponseAutomation' do
    it 'should create an instance of UpdateCommentAutomation200ResponseAutomation' do
      ...
      #expect(instance).to be_instance_of(Zernio::UpdateCommentAutomation200ResponseAutomation)
    end
  end
