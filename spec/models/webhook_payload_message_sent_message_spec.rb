...
# Unit tests for Late::WebhookPayloadMessageSentMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::WebhookPayloadMessageSentMessage do
  #let(:instance) { Late::WebhookPayloadMessageSentMessage.new }
  ...
  describe 'test an instance of WebhookPayloadMessageSentMessage' do
    it 'should create an instance of WebhookPayloadMessageSentMessage' do
      ...
      #expect(instance).to be_instance_of(Late::WebhookPayloadMessageSentMessage)
    end
  end
