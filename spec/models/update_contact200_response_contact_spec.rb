...
# Unit tests for Zernio::UpdateContact200ResponseContact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::UpdateContact200ResponseContact do
  #let(:instance) { Zernio::UpdateContact200ResponseContact.new }
  ...
  describe 'test an instance of UpdateContact200ResponseContact' do
    it 'should create an instance of UpdateContact200ResponseContact' do
      ...
      #expect(instance).to be_instance_of(Zernio::UpdateContact200ResponseContact)
    end
  end
