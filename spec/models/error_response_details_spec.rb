...
describe Zernio::ErrorResponseDetails do
  ...
  describe 'test attribute "stage"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["media", "campaign", "adset", "creative", "ad", "activation", "other"])
  ...
  describe 'test attribute "created_objects"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "unconfirmed_write"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
