...
# Unit tests for Zernio::CreateTrackingTagRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateTrackingTagRequest do
  #let(:instance) { Zernio::CreateTrackingTagRequest.new }

  describe 'test an instance of CreateTrackingTagRequest' do
    it 'should create an instance of CreateTrackingTagRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::CreateTrackingTagRequest)
    end
  end
