...
# Unit tests for Zernio::WhatsAppBodyComponent
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::WhatsAppBodyComponent do
  #let(:instance) { Zernio::WhatsAppBodyComponent.new }

  describe 'test an instance of WhatsAppBodyComponent' do
    it 'should create an instance of WhatsAppBodyComponent' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::WhatsAppBodyComponent)
    end
  end
