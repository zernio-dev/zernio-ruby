...
# Unit tests for Zernio::CreateWhatsAppTemplateRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateWhatsAppTemplateRequest do
  #let(:instance) { Zernio::CreateWhatsAppTemplateRequest.new }
  ...
  describe 'test an instance of CreateWhatsAppTemplateRequest' do
    it 'should create an instance of CreateWhatsAppTemplateRequest' do
      ...
      #expect(instance).to be_instance_of(Zernio::CreateWhatsAppTemplateRequest)
    end
  end
