...
# Unit tests for Zernio::ConnectWhatsAppCredentials200ResponseAccount
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::ConnectWhatsAppCredentials200ResponseAccount do
  #let(:instance) { Zernio::ConnectWhatsAppCredentials200ResponseAccount.new }
  ...
  describe 'test an instance of ConnectWhatsAppCredentials200ResponseAccount' do
    it 'should create an instance of ConnectWhatsAppCredentials200ResponseAccount' do
      ...
      #expect(instance).to be_instance_of(Zernio::ConnectWhatsAppCredentials200ResponseAccount)
    end
  end
