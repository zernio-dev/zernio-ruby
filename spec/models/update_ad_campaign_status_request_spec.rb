...
# Unit tests for Zernio::UpdateAdCampaignStatusRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::UpdateAdCampaignStatusRequest do
  #let(:instance) { Zernio::UpdateAdCampaignStatusRequest.new }
  ...
  describe 'test an instance of UpdateAdCampaignStatusRequest' do
    it 'should create an instance of UpdateAdCampaignStatusRequest' do
      ...
      #expect(instance).to be_instance_of(Zernio::UpdateAdCampaignStatusRequest)
    end
  end
