...
# Unit tests for Zernio::AdTreeCampaign
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::AdTreeCampaign do
  #let(:instance) { Zernio::AdTreeCampaign.new }

  describe 'test an instance of AdTreeCampaign' do
    it 'should create an instance of AdTreeCampaign' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::AdTreeCampaign)
    end
  end
