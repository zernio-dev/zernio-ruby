...
# Unit tests for Zernio::BoostPostRequestTargeting
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::BoostPostRequestTargeting do
  #let(:instance) { Zernio::BoostPostRequestTargeting.new }
  ...
  describe 'test an instance of BoostPostRequestTargeting' do
    it 'should create an instance of BoostPostRequestTargeting' do
      ...
      #expect(instance).to be_instance_of(Zernio::BoostPostRequestTargeting)
    end
  end
