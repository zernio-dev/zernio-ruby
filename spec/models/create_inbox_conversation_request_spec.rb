...
# Unit tests for Zernio::CreateInboxConversationRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateInboxConversationRequest do
  #let(:instance) { Zernio::CreateInboxConversationRequest.new }
  ...
  describe 'test an instance of CreateInboxConversationRequest' do
    it 'should create an instance of CreateInboxConversationRequest' do
      ...
      #expect(instance).to be_instance_of(Zernio::CreateInboxConversationRequest)
    end
  end
  ...
  describe 'test attribute "template_cards"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
