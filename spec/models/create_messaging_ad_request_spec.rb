...
# Unit tests for Zernio::CreateMessagingAdRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateMessagingAdRequest do
  #let(:instance) { Zernio::CreateMessagingAdRequest.new }

  describe 'test an instance of CreateMessagingAdRequest' do
    it 'should create an instance of CreateMessagingAdRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::CreateMessagingAdRequest)
    end
  end
  ...
  describe 'test attribute "object_story_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "destination"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["whatsapp", "messenger", "instagram_direct"])
      # validator.allowable_values.each do |value|
  ...
  describe 'test attribute "destinations"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Array<String>', ["whatsapp", "messenger", "instagram_direct"])
      # validator.allowable_values.each do |value|
      #   expect { instance.destinations = value }.not_to raise_error
      # end
    end
  end
