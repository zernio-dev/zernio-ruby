...
# Unit tests for Zernio::AdDailyMetrics
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::AdDailyMetrics do
  #let(:instance) { Zernio::AdDailyMetrics.new }

  describe 'test an instance of AdDailyMetrics' do
    it 'should create an instance of AdDailyMetrics' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::AdDailyMetrics)
    end
  end
