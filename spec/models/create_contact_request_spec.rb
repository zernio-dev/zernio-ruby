...
# Unit tests for Zernio::CreateContactRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateContactRequest do
  #let(:instance) { Zernio::CreateContactRequest.new }

  describe 'test an instance of CreateContactRequest' do
    it 'should create an instance of CreateContactRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::CreateContactRequest)
    end
  end
