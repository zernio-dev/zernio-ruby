...
# Unit tests for Zernio::PlatformTarget
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::PlatformTarget do
  #let(:instance) { Zernio::PlatformTarget.new }

  describe 'test an instance of PlatformTarget' do
    it 'should create an instance of PlatformTarget' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::PlatformTarget)
    end
  end
