...
# Unit tests for Zernio::ExternalPostMediaItem
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::ExternalPostMediaItem do
  #let(:instance) { Zernio::ExternalPostMediaItem.new }

  describe 'test an instance of ExternalPostMediaItem' do
    it 'should create an instance of ExternalPostMediaItem' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::ExternalPostMediaItem)
    end
  end
