...
# Unit tests for Zernio::GetYoutubePlaylists200ResponsePlaylistsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::GetYoutubePlaylists200ResponsePlaylistsInner do
  #let(:instance) { Zernio::GetYoutubePlaylists200ResponsePlaylistsInner.new }
  ...
  describe 'test an instance of GetYoutubePlaylists200ResponsePlaylistsInner' do
    it 'should create an instance of GetYoutubePlaylists200ResponsePlaylistsInner' do
      ...
      #expect(instance).to be_instance_of(Zernio::GetYoutubePlaylists200ResponsePlaylistsInner)
    end
  end
