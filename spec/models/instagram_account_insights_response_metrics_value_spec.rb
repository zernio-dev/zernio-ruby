...
# Unit tests for Zernio::InstagramAccountInsightsResponseMetricsValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::InstagramAccountInsightsResponseMetricsValue do
  #let(:instance) { Zernio::InstagramAccountInsightsResponseMetricsValue.new }
  ...
  describe 'test an instance of InstagramAccountInsightsResponseMetricsValue' do
    it 'should create an instance of InstagramAccountInsightsResponseMetricsValue' do
      ...
      #expect(instance).to be_instance_of(Zernio::InstagramAccountInsightsResponseMetricsValue)
    end
  end
