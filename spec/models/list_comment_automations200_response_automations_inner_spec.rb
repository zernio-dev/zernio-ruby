...
# Unit tests for Late::ListCommentAutomations200ResponseAutomationsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::ListCommentAutomations200ResponseAutomationsInner do
  #let(:instance) { Late::ListCommentAutomations200ResponseAutomationsInner.new }
  ...
  describe 'test an instance of ListCommentAutomations200ResponseAutomationsInner' do
    it 'should create an instance of ListCommentAutomations200ResponseAutomationsInner' do
      ...
      #expect(instance).to be_instance_of(Late::ListCommentAutomations200ResponseAutomationsInner)
    end
  end
