...
# Unit tests for Zernio::ListCommentAutomations200ResponseAutomationsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::ListCommentAutomations200ResponseAutomationsInner do
  #let(:instance) { Zernio::ListCommentAutomations200ResponseAutomationsInner.new }

  describe 'test an instance of ListCommentAutomations200ResponseAutomationsInner' do
    it 'should create an instance of ListCommentAutomations200ResponseAutomationsInner' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::ListCommentAutomations200ResponseAutomationsInner)
    end
  end
