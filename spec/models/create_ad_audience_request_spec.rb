...
# Unit tests for Late::CreateAdAudienceRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::CreateAdAudienceRequest do
  #let(:instance) { Late::CreateAdAudienceRequest.new }
  ...
  describe 'test an instance of CreateAdAudienceRequest' do
    it 'should create an instance of CreateAdAudienceRequest' do
      ...
      #expect(instance).to be_instance_of(Late::CreateAdAudienceRequest)
    end
  end
