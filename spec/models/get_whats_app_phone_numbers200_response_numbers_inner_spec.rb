...
# Unit tests for Zernio::GetWhatsAppPhoneNumbers200ResponseNumbersInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::GetWhatsAppPhoneNumbers200ResponseNumbersInner do
  #let(:instance) { Zernio::GetWhatsAppPhoneNumbers200ResponseNumbersInner.new }
  ...
  describe 'test an instance of GetWhatsAppPhoneNumbers200ResponseNumbersInner' do
    it 'should create an instance of GetWhatsAppPhoneNumbers200ResponseNumbersInner' do
      ...
      #expect(instance).to be_instance_of(Zernio::GetWhatsAppPhoneNumbers200ResponseNumbersInner)
    end
  end
