...
# Unit tests for Zernio::BillingSnapshot
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::BillingSnapshot do
  #let(:instance) { Zernio::BillingSnapshot.new }

  describe 'test an instance of BillingSnapshot' do
    it 'should create an instance of BillingSnapshot' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::BillingSnapshot)
    end
  end
