...
# Unit tests for Zernio::CreateSequenceRequestStepsInnerTemplateVariableMappingValue
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::CreateSequenceRequestStepsInnerTemplateVariableMappingValue do
  #let(:instance) { Zernio::CreateSequenceRequestStepsInnerTemplateVariableMappingValue.new }
  ...
  describe 'test an instance of CreateSequenceRequestStepsInnerTemplateVariableMappingValue' do
    it 'should create an instance of CreateSequenceRequestStepsInnerTemplateVariableMappingValue' do
      ...
      #expect(instance).to be_instance_of(Zernio::CreateSequenceRequestStepsInnerTemplateVariableMappingValue)
    end
  end
