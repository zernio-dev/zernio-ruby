...
# Unit tests for Zernio::UpdateAdCampaignStatus200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::UpdateAdCampaignStatus200Response do
  #let(:instance) { Zernio::UpdateAdCampaignStatus200Response.new }
  ...
  describe 'test an instance of UpdateAdCampaignStatus200Response' do
    it 'should create an instance of UpdateAdCampaignStatus200Response' do
      ...
      #expect(instance).to be_instance_of(Zernio::UpdateAdCampaignStatus200Response)
    end
  end
