...
# Unit tests for Zernio::AdCreative
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::AdCreative do
  #let(:instance) { Zernio::AdCreative.new }

  describe 'test an instance of AdCreative' do
    it 'should create an instance of AdCreative' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::AdCreative)
    end
  end
  ...
  describe 'test attribute "asset_group_resource_name"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "effective_object_story_id"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'test attribute "instagram_permalink_url"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
