...
# Unit tests for Zernio::AnalyticsListResponsePostsInner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::AnalyticsListResponsePostsInner do
  #let(:instance) { Zernio::AnalyticsListResponsePostsInner.new }
  ...
  describe 'test an instance of AnalyticsListResponsePostsInner' do
    it 'should create an instance of AnalyticsListResponsePostsInner' do
      ...
      #expect(instance).to be_instance_of(Zernio::AnalyticsListResponsePostsInner)
    end
  end
