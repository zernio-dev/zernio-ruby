...
# Unit tests for Late::InboxWebhookMessage
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::InboxWebhookMessage do
  #let(:instance) { Late::InboxWebhookMessage.new }

  describe 'test an instance of InboxWebhookMessage' do
    it 'should create an instance of InboxWebhookMessage' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::InboxWebhookMessage)
    end
  end
