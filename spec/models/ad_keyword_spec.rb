...
# Unit tests for Zernio::AdKeyword
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::AdKeyword do
  #let(:instance) { Zernio::AdKeyword.new }

  describe 'test an instance of AdKeyword' do
    it 'should create an instance of AdKeyword' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Zernio::AdKeyword)
    end
  end
