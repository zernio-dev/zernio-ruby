...
# Unit tests for Zernio::GetTikTokCreatorInfo200Response
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Zernio::GetTikTokCreatorInfo200Response do
  #let(:instance) { Zernio::GetTikTokCreatorInfo200Response.new }
  ...
  describe 'test an instance of GetTikTokCreatorInfo200Response' do
    it 'should create an instance of GetTikTokCreatorInfo200Response' do
      ...
      #expect(instance).to be_instance_of(Zernio::GetTikTokCreatorInfo200Response)
    end
  end
