...
# Unit tests for Late::UpdateAdSetRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Late::UpdateAdSetRequest do
  #let(:instance) { Late::UpdateAdSetRequest.new }

  describe 'test an instance of UpdateAdSetRequest' do
    it 'should create an instance of UpdateAdSetRequest' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(Late::UpdateAdSetRequest)
    end
  end
