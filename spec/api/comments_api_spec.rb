...
describe 'CommentsApi' do
  ...
  # @param post_id Zernio post ID or platform-specific post ID. Zernio IDs are auto-resolved. LinkedIn third-party posts accept full activity URN or numeric ID.
  # @param account_id 
  # @param [Hash] opts the optional parameters
