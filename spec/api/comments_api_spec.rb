...
# Unit tests for Zernio::CommentsApi
...
describe 'CommentsApi' do
  ...
  describe 'test an instance of CommentsApi' do
    it 'should create an instance of CommentsApi' do
      expect(@api_instance).to be_instance_of(Zernio::CommentsApi)
    end
  end
  ...
  # @option opts [String] :comment_id (Facebook, Instagram, Reddit and TikTok) Get replies to a specific comment. On Facebook and Instagram, the requested comment is returned in the top-level &#x60;comment&#x60; field and comments[] holds its replies.
  ...
  # @option opts [Integer] :min_comments Minimum comment count, applied to each page after pagination
