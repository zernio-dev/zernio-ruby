...
describe 'AdAccountsApi' do
  ...
  # unit tests for list_ads_instagram_posts
  ...
  # @param account_id Zernio Meta Ads, Facebook or Instagram SocialAccount ID.
  # @param [Hash] opts the optional parameters
  ...
  # @option opts [Integer] :limit Number of posts to return per page.
  ...
  describe 'list_ads_instagram_posts test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
