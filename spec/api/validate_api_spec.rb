...
# Unit tests for Zernio::ValidateApi
...
describe 'ValidateApi' do
  ...
  describe 'test an instance of ValidateApi' do
    it 'should create an instance of ValidateApi' do
      expect(@api_instance).to be_instance_of(Zernio::ValidateApi)
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @option opts [String] :account_id Reddit account ID for authenticated lookup (recommended for reliable results)
