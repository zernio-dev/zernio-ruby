...
describe 'MessagesApi' do
  ...
  # @param conversation_id The conversation ID
  # @param message_id The platform message ID to edit (iMessage also accepts the Zernio message id)
  ...
  # @param account_id Account ID. Required: without it the request returns 400 missing_required_field.
  # @param [Hash] opts the optional parameters
  ...
  # unit tests for set_conversation_thread_control
  ...
  # @param conversation_id The conversation ID
  # @param set_conversation_thread_control_request 
  # @param [Hash] opts the optional parameters
  # @return [SetConversationThreadControl200Response]
  describe 'set_conversation_thread_control test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
