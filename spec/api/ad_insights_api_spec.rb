...
describe 'AdInsightsApi' do
  ...
  # @option opts [String] :ad_set_id Platform ad set ID (Google ad group). Same value as adSetId on listAdKeywords and /ad-sets/{adSetId}/assets.
  # @option opts [String] :ad_group_id Alias of adSetId, kept for existing callers.
  ...
  # unit tests for get_tik_tok_smart_plus_material_report
  ...
  # @param account_id A tiktok or tiktokads account ID
  # @param ad_account_id TikTok advertiser ID
  # @param start_date YYYY-MM-DD, in the advertiser&#39;s time zone
  # @param end_date YYYY-MM-DD, on or after startDate
  # @param [Hash] opts the optional parameters
  # @option opts [String] :level Key each row by Smart+ ad or by ad group
  # @option opts [String] :smart_plus_ad_ids Comma-separated Smart+ ad ids to filter by (up to 100)
  # @option opts [String] :ad_group_ids Comma-separated ad group ids to filter by (up to 100)
  # @option opts [Integer] :page 
  # @option opts [Integer] :page_size 
  # @return [GetTikTokSmartPlusMaterialReport200Response]
  describe 'get_tik_tok_smart_plus_material_report test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_local_services_lead_conversations
  ...
  # @param lead_id Numeric lead id from /v1/ads/local-services/leads.
  # @param account_id Google ads SocialAccount id.
  # @param [Hash] opts the optional parameters
  # @option opts [String] :ad_account_id Platform ad account ID (Google customer ID, digits only). Defaults to the account&#39;s connected customer.
  # @option opts [String] :customer_id Alias of adAccountId, kept for existing callers
  ...
  describe 'list_local_services_lead_conversations test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_local_services_leads
  ...
  # @option opts [String] :ad_account_id Platform ad account ID (Google customer ID, digits only). Defaults to the account&#39;s connected customer.
  # @option opts [String] :customer_id Alias of adAccountId, kept for existing callers
  # @option opts [Date] :from_date Leads created at/after this day.
  # @option opts [Date] :to_date Leads created at/before this day.
  # @option opts [String] :lead_type 
  # @option opts [String] :lead_status Google LocalServicesLeadStatus enum value (e.g. NEW, BOOKED, WIPED_OUT).
  # @option opts [Boolean] :charged_only true &#x3D; only leads Google charged for.
  # @option opts [String] :page_token Cursor from paging.nextPageToken of the previous page.
  # @return [ListLocalServicesLeads200Response]
  describe 'list_local_services_leads test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @option opts [String] :ad_account_id Google only: platform ad account ID (Google customer ID, digits only) when the connection has several Google Ads accounts.
  # @option opts [String] :customer_id Alias of adAccountId, kept for existing callers
  ...
  # @option opts [String] :action_breakdowns Comma-separated Graph action breakdowns; segments the actions[] arrays in each row. Pass &#x60;none&#x60; to clear Meta&#39;s default action_type breakdown, required to combine some non-action breakdowns such as instagram_ads_follow_type (otherwise Meta returns a (#100) invalid-combination error).
