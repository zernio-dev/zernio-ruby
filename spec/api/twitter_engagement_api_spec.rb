...
describe 'TwitterEngagementApi' do
  ...
  # @param account_id The account ID whose X token is used for the lookup
  # @param tweet_id Numeric tweet ID or a tweet URL (e.g. https://x.com/user/status/123...). The same name the other /v1/twitter operations use (retweet, bookmark).
  # @param [Hash] opts the optional parameters
  # @option opts [String] :id Alias of tweetId, kept for existing callers
  ...
  # @param account_id 
  # @param target_user_id The X ID of the user to unfollow
  # @param [Hash] opts the optional parameters
