...
describe 'WhatsAppApi' do
  ...
  # unit tests for get_whats_app_commerce_settings
  ...
  describe 'get_whats_app_commerce_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for link_whats_app_catalog
  ...
  # @param link_whats_app_catalog_request 
  # @param [Hash] opts the optional parameters
  # @return [ListWhatsAppCatalogs200Response]
  describe 'link_whats_app_catalog test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  describe 'list_whats_app_account_events test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for list_whats_app_catalogs
  ...
  # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
  # @return [ListWhatsAppCatalogs200Response]
  describe 'list_whats_app_catalogs test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for unlink_whats_app_catalog
  # Unlink a catalog from a WhatsApp number
  # @param account_id WhatsApp account ID
  # @param catalog_id Meta catalog ID
  # @param [Hash] opts the optional parameters
  # @option opts [String] :catalog_account_id A facebook, instagram or metaads account whose Meta login carries catalog_management; its token performs the call instead of the account&#39;s own
  # @return [UnlinkWhatsAppCatalog200Response]
  describe 'unlink_whats_app_catalog test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for update_whats_app_commerce_settings
  # Update a number&#39;s commerce settings
  # @param update_whats_app_commerce_settings_request 
  # @param [Hash] opts the optional parameters
  # @return [GetWhatsAppCommerceSettings200Response]
  describe 'update_whats_app_commerce_settings test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
